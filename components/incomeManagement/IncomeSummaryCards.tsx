...
import { useGetIncomeSummaryQuery } from "@/services/api/constants/expense.constant";
...
const IncomeSummaryCards = () => {
    ...
    const { data: summaryData, isLoading } = useGetIncomeSummaryQuery(
        { startDate, endDate },
